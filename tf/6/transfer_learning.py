...
def main(argv):
    ...
    cross_entropy = tf.nn.softmax_cross_entropy_with_logits(
        logits=logits, labels=tf.argmax(ground_truth_input))
    ...
    with tf.Session() as sess:
        ...
        for i in range(STEPS):
            train_bottlenecks, train_ground_truth = \
                get_random_cache_bottlenecks(sess, n_classes, image_lists, 
            ...
            if i % 100 == 0 or i+1 ==STEPS:
                ...
                print('Steps %d: Validation accuracy on random sampled %d examples = %.1f%%' %
